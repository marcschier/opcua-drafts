...
description: >-
  ...
  (spec-drafts/cloud-specs/observability-export). WHEN: make a companion spec observable, export a
...
(`spec-drafts/cloud-specs/observability-export/OPC-UA-Observability-Export.md`). A binding declares how the
