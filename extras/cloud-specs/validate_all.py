...
Usage (from repo root):
    python extras/cloud-specs/validate_all.py                  # all cloud-specs extensions
    python extras/cloud-specs/validate_all.py --self-contained # only checks that need no untracked ref data (CI)
...
def run(targets):
    ...
    for rel in targets:
        ...
        print(f"=== extras/cloud-specs/{rel} ===")
