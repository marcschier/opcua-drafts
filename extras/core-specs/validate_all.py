...
Usage (from repo root):
    python extras/core-specs/validate_all.py                  # all extensions (needs local ref data)
    python extras/core-specs/validate_all.py --self-contained # only checks that need no gitignored
                                                              # ref data (used by CI)
...
SELF_CONTAINED = [
    ...
    "_common/tests/test_control_roundtrip.py",
    "_common/tests/test_helpers.py",
...
# their specifications to cloud-specs/, and are driven by extras/cloud-specs/validate_all.py — the
