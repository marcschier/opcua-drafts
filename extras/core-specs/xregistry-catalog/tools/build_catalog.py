...
Usage (from repo root):
  python extras/core-specs/xregistry-catalog/tools/build_catalog.py [NODESET_XML]
Writes: extras/core-specs/xregistry-catalog/examples/opcua-catalog.xregistry.json
"""
...
# After the reorg this tool lives under extras/core-specs/xregistry-catalog/tools,
# so this resolves to extras/core-specs (where the sibling encodings' generated
...
DEFAULT_NODESET = os.path.join(
    REPO, "extras", "core-specs", "_common", "nodesets",
