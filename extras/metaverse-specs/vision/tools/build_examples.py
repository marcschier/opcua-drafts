...
Usage (from the repo root):
    python extras/metaverse-specs/vision/tools/build_examples.py            # all descriptors
    python extras/metaverse-specs/vision/tools/build_examples.py <file.json>
...
def emit_addendum(d, annex=None):
    ...
    rel = (f"{source_root}/extras/metaverse-specs/vision/examples/"
