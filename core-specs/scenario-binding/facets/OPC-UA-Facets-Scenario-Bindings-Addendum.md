...
*Non-normative. Companion to the [base specification](../OPC-UA-Scenario-Bindings.md), section “Binding inheritance and facet composition” (§5.12). Generated by [`core-specs/extras/scenario-binding/examples/facets/build_facets_example.py`](../../extras/scenario-binding/examples/facets/build_facets_example.py) from the self-contained [`Opc.Ua.FacetDemo.NodeSet2.xml`](../../extras/scenario-binding/examples/facets/Opc.Ua.FacetDemo.NodeSet2.xml) model.*
