...
*URI:* `http://opcfoundation.org/UA/PubSub/Scenarios/Observability` · *Direction:* Publisher · *Content:* data DataSet (PublishedDataItems) · *DataSetClassId:* `c2bdda35-eefe-569a-ab7a-779eabd7d611` · *Cardinality:* one DataSet (bound root)
...
| File | Content |
|---|---|
| [`DIDeviceHealth.ScenarioBinding.json`](DIDeviceHealth.ScenarioBinding.json) | Machine-readable ScenarioBindingConfiguration descriptor (single source). |
...
Regenerate with `python ../tools/build_bindings.py didevicehealth/DIDeviceHealth.ScenarioBinding.json`.
