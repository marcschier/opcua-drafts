...
| File | Content |
|---|---|
| [`DI.ScenarioBinding.json`](DI.ScenarioBinding.json) | Machine-readable ScenarioBindingConfiguration descriptor (single source). |
...
Regenerate with `python ../tools/build_bindings.py di/DI.ScenarioBinding.json`.
