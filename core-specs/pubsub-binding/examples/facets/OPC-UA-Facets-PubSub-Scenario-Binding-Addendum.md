# OPC UA — PubSub Scenario Binding — Facets & Inheritance Addendum

*Non-normative. Companion to the base specification, section “Binding inheritance and facet composition” (§5.13). Generated by `build_facets_example.py` from the self-contained `Opc.Ua.FacetDemo.NodeSet2.xml` model.*
