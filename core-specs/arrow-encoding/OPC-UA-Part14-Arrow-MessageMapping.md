...
3. Fetch the schema from the out-of-band xRegistry by matching the `opcua.schemaid` label, as defined by *OPC UA — xRegistry Schema Catalog* (`../xregistry-catalog/OPC-UA-xRegistry-Schema-Catalog.md`) §6.
