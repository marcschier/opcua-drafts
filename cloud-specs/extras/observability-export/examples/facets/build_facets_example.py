...
def emit_addendum(db):
    ...
    A("")
    A("*Non-normative. Companion to the [base specification](../OPC-UA-Observability-Export.md), "
      "section “Binding inheritance and facet composition” (§5.12). Generated by "
      "[`cloud-specs/extras/observability-export/examples/facets/build_facets_example.py`]"
...
def main():
    ...
    em = Emit()
    xml = em.document()
    # Standardized outputs (overlay + addendum) land in cloud-specs/observability-export/facets/;
