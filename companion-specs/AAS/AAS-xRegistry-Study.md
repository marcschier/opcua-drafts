...
| Document | What it is |
|---|---|
| [`OPC-UA-AAS.md`](OPC-UA-AAS.md) | OPC 30270 draft 3.00-draft2 — the AAS V3 metamodel mapped losslessly onto OPC UA in its own provisional namespace, together with the same registry as an xRegistry domain extension |
