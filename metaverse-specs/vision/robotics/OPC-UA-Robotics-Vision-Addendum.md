...
**Implementer annex to *OPC UA — Vision* (Release 0.4.0 — Draft).**
...
- *OPC UA — Vision*, Release 0.4.0 (the base specification), `../OPC-UA-Vision.md`.
...
| [`Opc.Ua.Robotics.Vision.NodeSet2.xml`](Opc.Ua.Robotics.Vision.NodeSet2.xml) | The generated instance overlay. |
