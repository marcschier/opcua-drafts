...
**Release 0.3.0 — Draft.** An OPC UA information model for commanding a robot at the level of task intent, with a lifecycle that survives the minutes such work actually takes.
