# OpenUSD Artifact Registry Service - Version 1.0-rc1

<!-- words: OpenUSD usd usda usdc usdz usdi AOUSD MaterialX mtlx OpenVDB Alembic Omniverse -->
<!-- words: prim prims sublayer sublayers subLayers payload payloads referenced resolver resolvers -->
<!-- words: usdasset usdassets usdassetid usdasseturl usdassetbase64 usdassetsurl usdassetscount usdassetbase -->
<!-- words: usdassetgroup usdassetgroups usdassetgroupid usdassetgroupsurl usdassetgroupscount -->
<!-- words: usdschemaplugingroup usdschemaplugingroups usdschemaplugingroupid usdschemaplugingroupsurl usdschemaplugingroupscount -->
<!-- words: assetidentifier assetkind dependson digestalg rootlayer plugInfo generatedSchema -->
<!-- words: rootlayer sublayer materialx codeless plugin plugins schemas hasdocument -->
<!-- words: formatvalidated compatibilityvalidated formatvalidatedreason compatibilityvalidatedreason -->
<!-- words: fabrikam contoso pumps robotics plant turbine -->
...
- [OpenUSD Artifact Registry Service - Version 1.0-rc1](#openusd-artifact-registry-service---version-10-rc1)
  - [Abstract](#abstract)
...
publisher may compose a scene by authoring references at runtime, in which case
...
A registry is not required to host every artifact it knows about. An artifact
