...
folder_member(S, "OpenUsdStageType", "Assets",
              ...
              "by several stages exists once in the registry. Present only when the server "
              "delivers its geometry; a connector that finds it fetches and composes the stage "
              "locally, else it resolves RootLayerIdentifier externally.",
              rule=MR_Optional)
