...
It realizes the collaboration flow described in Annex D of the base specification (`../../../openusd-binding/OPC-UA-OpenUSD-Bindings.md`). This document lives **outside** the normative spec; it is a tutorial for implementers.
