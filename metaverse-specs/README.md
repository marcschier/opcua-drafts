...
For a short browse-oriented introduction to the two models and their ownership boundary, see <!-- release-spec-link:W1Zpc2lvbiBhbmQgQUkgTW9kZWwgTWFuYWdlbWVudCB3YWxrdGhyb3VnaF0oLi4vc291cmNlL21ldGF2ZXJzZS1zcGVjcy92aXNpb24tYWktd2Fsa3Rocm91Z2gubWQp -->[Vision and AI Model Management walkthrough](https://github.com/OPCF-Members/spec-drafts/blob/main/source/metaverse-specs/vision-ai-walkthrough.md)<!-- /release-spec-link -->. For transport-neutral guidance on retaining Vision results outside an OPC UA Server, see <!-- release-spec-link:W0V4dGVybmFsIFJlc3VsdCBNYXBwaW5nIGZvciBWaXNpb24gYW5kIEFJXSguLi9zb3VyY2UvbWV0YXZlcnNlLXNwZWNzL3Zpc2lvbi1haS1leHRlcm5hbC1yZXN1bHQtbWFwcGluZy5tZCk= -->[External Result Mapping for Vision and AI](https://github.com/OPCF-Members/spec-drafts/blob/main/source/metaverse-specs/vision-ai-external-result-mapping.md)<!-- /release-spec-link -->.
