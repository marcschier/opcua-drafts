...
|---|---|---|
| `spec.md` | **OPC 30270 draft 3.00-draft4** — the AAS V3 metamodel mapped losslessly onto OPC UA in the provisional `http://opcfoundation.org/UA/I4AAS/v3/` namespace, together with an AAS Registry built on the abstract xRegistry base | OPC Foundation |
