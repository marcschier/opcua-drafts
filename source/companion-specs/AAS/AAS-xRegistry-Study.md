...
| Document | What it is |
|---|---|
| [`spec.md`](spec.md) | OPC 30270 draft 3.00-draft4 — the AAS V3 metamodel mapped losslessly onto OPC UA in its own provisional namespace, together with the same registry as an xRegistry domain extension |
...
| 10 | Project the registry into OPC UA | **Done** — [`spec.md`](spec.md), which also revises the AAS metamodel mapping to V3 and makes it lossless |
