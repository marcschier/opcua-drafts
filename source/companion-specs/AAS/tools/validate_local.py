...
XML = os.path.join(MODEL, "Opc.Ua.I4AAS.NodeSet2.xml")
CSVF = os.path.join(MODEL, "Opc.Ua.I4AAS.NodeIds.csv")
...
_xr_candidates = [
    ...
    os.path.join(ROOT, "spec-drafts", "model", "core-specs", "xregistry",
...
if os.path.exists(_annex) and os.path.exists(_spec):
    ...
    if "kind: annex-a" not in normalized:
