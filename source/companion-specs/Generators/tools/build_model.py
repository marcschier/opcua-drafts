...
IA is a transitive RequiredModel of Machinery but is not listed in NamespaceUris
because no Node in this model references the IA namespace directly.
"""
...
# OPC 10000-5 requires a Server to publish metadata for every hosted namespace.
# These Nodes are appended after the domain model, preserving every earlier NodeId.
