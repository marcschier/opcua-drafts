...
- Declared the complete ordered dependency closure `UA`, `DI`, `IA`, `Machinery`; Machinery borrows IA types and therefore has to load after IA.
- Added the required NamespaceMetadata Object without changing any previously assigned NodeId.
