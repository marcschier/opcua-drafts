...
## 2. Base facet bindings {#sec-2-base-facet-bindings}
...
## 3. Derived bindings — delta only {#sec-3-derived-bindings-delta-only}
...
## 4. What the bridge produces — the composed DataSets {#sec-4-what-the-bridge-produces-the-composed-datasets}
...
### `MachineObservability` — Metrics DataSet (8 fields, class `53dc8a49…`) {#sec-machineobservability-metrics-dataset-8-fields-class-53dc8a49}
...
### `MachineMaintenance` — Metrics DataSet (1 fields, class `53dc8a49…`) {#sec-machinemaintenance-metrics-dataset-1-fields-class-53dc8a49}

| Field | Resolved BrowsePath (on a Machine instance) | From facet | Provenance `SourceObservabilityExportClassId` | Note |
|---|---|---|---|---|
| `LastMaintenanceDate` | `/LastMaintenanceDate` | Maintenance | `7e967a1b…` | inherited |

## 5. Facet-scoped subset recognition {#sec-5-facet-scoped-subset-recognition}
...
## 6. Where the binding nodes live {#sec-6-where-the-binding-nodes-live}
