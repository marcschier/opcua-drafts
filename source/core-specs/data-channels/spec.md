...
## Design overview {#sec-design-overview}

### Two channel models {#sec-two-channel-models}
...
### The design in one page {#sec-the-design-in-one-page}
...
### What the outer-protocol model adds {#sec-what-the-outer-protocol-model-adds}
...
### The five flags {#sec-the-five-flags}
...
## Flow control, scheduling and loss {#sec-flow-control-scheduling-and-loss}
...
### Two scheduling obligations {#sec-two-scheduling-obligations}
...
### State, and what "unreliable" means {#sec-state-and-what-unreliable-means}
...
## DataChannel service set {#sec-datachannel-service-set}
...
### OpenDataChannel {#sec-opendatachannel}
...
### ModifyDataChannel {#sec-modifydatachannel}
...
### CloseDataChannel {#sec-closedatachannel}
...
### Server-initiated channels without inverting the model {#sec-server-initiated-channels-without-inverting-the-model}
...
### Defaults, ranges and the no-preference sentinel {#sec-defaults-ranges-and-the-no-preference-sentinel}
...
The complete node reference is [Annex A](#anx-a).

## Interoperability with implementations that do not support data channels {#sec-interoperability-with-implementations-that-do-not-support-data-channels}
...
## The QUIC transport {#sec-the-quic-transport}

### Why an outer-protocol binding {#sec-why-an-outer-protocol-binding}
...
### URL scheme, ALPN and discovery {#sec-url-scheme-alpn-and-discovery}
...
### Connection, control stream and channel streams {#sec-connection-control-stream-and-channel-streams}
...
### Unreliable datagrams {#sec-unreliable-datagrams}
...
### Security and the TLS binding {#sec-security-and-the-tls-binding}
...
### Connection migration {#sec-connection-migration}
...
### Congestion control {#sec-congestion-control}
...
### Choosing between transports {#sec-choosing-between-transports}
...
## The WebTransport over HTTP/3 transport {#sec-the-webtransport-over-http-3-transport}

### Why an outer-protocol binding {#sec-why-an-outer-protocol-binding-x}
...
### URL scheme, ALPN and discovery {#sec-url-scheme-alpn-and-discovery-x}
...
### Connection, control stream and channel streams {#sec-connection-control-stream-and-channel-streams-x}
...
### Unreliable datagrams {#sec-unreliable-datagrams-x}
...
### Security and intermediaries {#sec-security-and-intermediaries}
...
### Reverse connect {#sec-reverse-connect}
...
## What it costs {#sec-what-it-costs}
...
Figures, method and the full caveats are in the companion report, [OPC UA Data Channel Throughput](../../../core-specs/extras/performance/OPC-UA-Data-Channel-Throughput.md). They are loopback measurements, bound by CPU and cryptography rather than by a network, and are useful for comparing the transports against each other rather than as a statement about any real link.
...
## Annotated byte layouts {#anx-b annex=normative}
...
## A worked media session (informative) {#anx-c annex=normative}
...
## Comparison with WebRTC (informative) {#anx-d annex=normative}
...
## When to use which mechanism (informative) {#anx-e annex=normative}
...
## A worked reverse-connect `opc.quic` session (informative) {#anx-f annex=normative}
...
### IDataChannelSourceType {#sec-idatachannelsourcetype}
...
*Table - IDataChannelSourceType Definition* {#tbl-idatachannelsourcetype-definition defines=IDataChannelSourceType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:IDataChannelSourceType |  |  |  |  |
| IsAbstract | True |  |  |  |  |
...
### DataChannelSourceType {#sec-datachannelsourcetype}
...
*Table - DataChannelSourceType Definition* {#tbl-datachannelsourcetype-definition defines=DataChannelSourceType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelSourceType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DataChannelCapabilitiesType {#sec-datachannelcapabilitiestype}
...
*Table - DataChannelCapabilitiesType Definition* {#tbl-datachannelcapabilitiestype-definition defines=DataChannelCapabilitiesType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelCapabilitiesType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| DCH-Model |  |  |  |  |  |
| DCH-ModelDiagnostics |  |  |  |  |  |

### DataChannelOfferedEventType {#sec-datachannelofferedeventtype}
...
*Table - DataChannelOfferedEventType Definition* {#tbl-datachannelofferedeventtype-definition defines=DataChannelOfferedEventType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelOfferedEventType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DataChannelStateChangeEventType {#sec-datachannelstatechangeeventtype}
...
*Table - DataChannelStateChangeEventType Definition* {#tbl-datachannelstatechangeeventtype-definition defines=DataChannelStateChangeEventType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelStateChangeEventType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### AuditOpenDataChannelEventType {#sec-auditopendatachanneleventtype}
...
*Table - AuditOpenDataChannelEventType Definition* {#tbl-auditopendatachanneleventtype-definition defines=AuditOpenDataChannelEventType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:AuditOpenDataChannelEventType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DataChannelDirection {#sec-datachanneldirection}
...
*Table - DataChannelDirection Definition* {#tbl-datachanneldirection-definition defines=DataChannelDirection}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelDirection |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DataChannelDeliveryMode {#sec-datachanneldeliverymode}
...
*Table - DataChannelDeliveryMode Definition* {#tbl-datachanneldeliverymode-definition defines=DataChannelDeliveryMode}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelDeliveryMode |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| DCH-Model |  |  |  |  |  |
| DCH-PartialReliability |  |  |  |  |  |

### DataChannelState {#sec-datachannelstate}
...
*Table - DataChannelState Definition* {#tbl-datachannelstate-definition defines=DataChannelState}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelState |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DataChannelParametersDataType {#sec-datachannelparametersdatatype}
...
*Table - DataChannelParametersDataType Definition* {#tbl-datachannelparametersdatatype-definition defines=DataChannelParametersDataType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelParametersDataType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DataChannelStatusDataType {#sec-datachannelstatusdatatype}

The runtime state of one open data channel, as published by its endpoint.

*Table - DataChannelStatusDataType Definition* {#tbl-datachannelstatusdatatype-definition defines=DataChannelStatusDataType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelStatusDataType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DataChannelOfferDataType {#sec-datachannelofferdatatype}
...
*Table - DataChannelOfferDataType Definition* {#tbl-datachannelofferdatatype-definition defines=DataChannelOfferDataType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelOfferDataType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DataChannelDiagnosticsDataType {#sec-datachanneldiagnosticsdatatype}
...
*Table - DataChannelDiagnosticsDataType Definition* {#tbl-datachanneldiagnosticsdatatype-definition defines=DataChannelDiagnosticsDataType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DataChannelDiagnosticsDataType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### HasDataChannel {#sec-hasdatachannel}
...
*Table - HasDataChannel Definition* {#tbl-hasdatachannel-definition defines=HasDataChannel}
