...
### Built-in Boolean {#sec-built-in-boolean}
...
### Built-in SByte {#sec-built-in-sbyte}
...
### Built-in Byte {#sec-built-in-byte}
...
### Built-in Int16 {#sec-built-in-int16}
...
### Built-in UInt16 {#sec-built-in-uint16}
...
### Built-in Int32 {#sec-built-in-int32}
...
### Built-in UInt32 {#sec-built-in-uint32}
...
### Built-in Int64 {#sec-built-in-int64}
...
### Built-in UInt64 {#sec-built-in-uint64}
...
### Built-in Float {#sec-built-in-float}
...
### Built-in Double {#sec-built-in-double}
...
### Built-in String {#sec-built-in-string}
...
### Built-in DateTime {#sec-built-in-datetime}
...
### Built-in Guid {#sec-built-in-guid}
...
### Built-in ByteString {#sec-built-in-bytestring}
...
### Built-in XmlElement {#sec-built-in-xmlelement}
...
### Built-in NodeId {#sec-built-in-nodeid}
...
### Built-in ExpandedNodeId {#sec-built-in-expandednodeid}
...
### Built-in StatusCode {#sec-built-in-statuscode}
...
### Built-in QualifiedName {#sec-built-in-qualifiedname}
...
### Built-in LocalizedText {#sec-built-in-localizedtext}
...
### Built-in ExtensionObject {#sec-built-in-extensionobject}
...
### Built-in DataValue {#sec-built-in-datavalue}
...
### Built-in Variant {#sec-built-in-variant}
...
### Built-in DiagnosticInfo {#sec-built-in-diagnosticinfo}
...
### Composite Array<String> {#sec-composite-array-string}
...
### Composite Matrix<Double> {#sec-composite-matrix-double}
...
### Composite plain Structure Point {#sec-composite-plain-structure-point}
...
### Composite StructureWithOptionalFields Person {#sec-composite-structurewithoptionalfields-person}
...
### Composite dense Union Measurement {#sec-composite-dense-union-measurement}
...
### Worked structured DataType Envelope {#sec-worked-structured-datatype-envelope}
