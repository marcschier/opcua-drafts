...
### What OPC UA has today {#sec-what-opc-ua-has-today}
...
### Why a Service, and not another Method {#sec-why-a-service-and-not-another-method}
...
### Deferral in one paragraph {#sec-deferral-in-one-paragraph}
...
## The Complete Service {#sec-the-complete-service}
...
### Why the response is polymorphic {#sec-why-the-response-is-polymorphic}
...
## Deferring a request {#sec-deferring-a-request}

### When a Server may defer {#sec-when-a-server-may-defer}
...
### The deferral headers {#sec-the-deferral-headers}
...
### The retry contract {#sec-the-retry-contract}
...
### requestHandle uniqueness {#sec-requesthandle-uniqueness}
...
### States and the two deadlines {#sec-states-and-the-two-deadlines}
...
### An effect happens once; a response may be replayed {#sec-an-effect-happens-once-a-response-may-be-replayed}
...
### Authorization, and what a deferral does not do {#sec-authorization-and-what-a-deferral-does-not-do}
...
### Order of evaluation {#sec-order-of-evaluation}
...
## Interaction with other Services {#sec-interaction-with-other-services}
...
## The information model {#sec-the-information-model}
...
```{figure}
id: fig-async-notation
caption: Graphical notation used by the AddressSpace figures
source: figures/AsyncServices-FigNotation.png
```

### Server capabilities {#sec-server-capabilities}
...
<!-- model-figure: root=i=70000 require=mandatory external=BaseObjectType,ServerCapabilities  graph=figures/fig-async-capabilities.mmd -->

```{figure}
id: fig-async-capabilities
caption: The capabilities Object and where a Client finds it
source: figures/AsyncServices-FigCapabilities.png
```
...
<!-- model-figure: root=i=70001 require=mandatory external=BaseObjectType,ServerDiagnostics  graph=figures/fig-async-diagnostics.mmd -->

```{figure}
id: fig-async-diagnostics
caption: The diagnostics Object and its counters
source: figures/AsyncServices-FigDiagnostics.png
```
...
<!-- model-figure: root=i=70010 require=mandatory external=BaseEventType  graph=figures/fig-async-completed.mmd -->

```{figure}
id: fig-async-completed
caption: The completion Event
source: figures/AsyncServices-FigCompletedEvent.png
```
...
<!-- model-figure: root=i=70011 require=mandatory external=AuditSessionEventType  graph=figures/fig-async-audit.mmd -->

```{figure}
id: fig-async-audit
caption: The audit Event
source: figures/AsyncServices-FigAuditEvent.png
```
...
## Conformance units {#sec-conformance-units}
...
## A worked gateway deployment (informative) {#anx-b annex=informative}
...
### B.1 The exchange {#sec-b-1-the-exchange}
...
### B.2 The five outcomes, and which of them this specification addresses {#sec-b-2-the-five-outcomes-and-which-of-them-this-specification-addresses}
...
## Choosing between deferral and the alternatives (informative) {#anx-c annex=informative}
...
### AsyncServiceCapabilitiesType {#sec-asyncservicecapabilitiestype}
...
*Table - AsyncServiceCapabilitiesType Definition* {#tbl-asyncservicecapabilitiestype-definition defines=AsyncServiceCapabilitiesType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:AsyncServiceCapabilitiesType |  |  |  |  |
| IsAbstract | False |  |  |  |  |

| **References** | **Node Class** | **BrowseName** | **DataType** | **TypeDefinition** | **Other** |
| --- | --- | --- | --- | --- | --- |
| Subtype of the 0:BaseObjectType defined in OPC 10000-5 |  |  |  |  |  |
| 0:HasProperty | Variable | 0:MaxDeferredRequests | 0:UInt32 | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:MaxDeferredRequestsPerSession | 0:UInt32 | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:MaxDeferralTime | 0:Duration | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:DefaultRetryAfter | 0:Duration | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:MinRetryAfter | 0:Duration | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:DeferrableServices | 0:NodeId[] | 0:PropertyType | M |

| **Conformance Units** |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| ASE-Model |  |  |  |  |  |

### AsyncServiceDiagnosticsType {#sec-asyncservicediagnosticstype}
...
*Table - AsyncServiceDiagnosticsType Definition* {#tbl-asyncservicediagnosticstype-definition defines=AsyncServiceDiagnosticsType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:AsyncServiceDiagnosticsType |  |  |  |  |
| IsAbstract | False |  |  |  |  |

| **References** | **Node Class** | **BrowseName** | **DataType** | **TypeDefinition** | **Other** |
| --- | --- | --- | --- | --- | --- |
| Subtype of the 0:BaseObjectType defined in OPC 10000-5 |  |  |  |  |  |
| 0:HasComponent | Variable | 0:DeferredRequestCount | 0:UInt32 | 0:BaseDataVariableType | M |
| 0:HasComponent | Variable | 0:TotalDeferredCount | 0:Counter | 0:BaseDataVariableType | M |
| 0:HasComponent | Variable | 0:CompletedCount | 0:Counter | 0:BaseDataVariableType | M |
| 0:HasComponent | Variable | 0:ExpiredCount | 0:Counter | 0:BaseDataVariableType | M |
| 0:HasComponent | Variable | 0:CancelledCount | 0:Counter | 0:BaseDataVariableType | M |
| 0:HasComponent | Variable | 0:RejectedCount | 0:Counter | 0:BaseDataVariableType | M |
| 0:HasComponent | Variable | 0:DeferredRequests | 0:DeferredRequestDiagnosticsDataType[] | 0:BaseDataVariableType | M |

| **Conformance Units** |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| ASE-Diagnostics |  |  |  |  |  |

### DeferredRequestCompletedEventType {#sec-deferredrequestcompletedeventtype}
...
*Table - DeferredRequestCompletedEventType Definition* {#tbl-deferredrequestcompletedeventtype-definition defines=DeferredRequestCompletedEventType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DeferredRequestCompletedEventType |  |  |  |  |
| IsAbstract | False |  |  |  |  |

| **References** | **Node Class** | **BrowseName** | **DataType** | **TypeDefinition** | **Other** |
| --- | --- | --- | --- | --- | --- |
| Subtype of the 0:BaseEventType defined in OPC 10000-5 |  |  |  |  |  |
| 0:HasProperty | Variable | 0:RequestHandle | 0:IntegerId | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:ServiceId | 0:NodeId | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:ServiceResult | 0:StatusCode | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:CompletionTime | 0:UtcTime | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:ExpiryTime | 0:UtcTime | 0:PropertyType | M |

| **Conformance Units** |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| ASE-CompletionEvents |  |  |  |  |  |

### AuditDeferredRequestEventType {#sec-auditdeferredrequesteventtype}
...
*Table - AuditDeferredRequestEventType Definition* {#tbl-auditdeferredrequesteventtype-definition defines=AuditDeferredRequestEventType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:AuditDeferredRequestEventType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
| 0:HasProperty | Variable | 0:RequestHandle | 0:IntegerId | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:ServiceId | 0:NodeId | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:Transition | 0:DeferredRequestTransition | 0:PropertyType | M |
| 0:HasProperty | Variable | 0:Outcome | 0:StatusCode | 0:PropertyType | M |

| **Conformance Units** |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| ASE-Auditing |  |  |  |  |  |

### DeferredRequestState {#sec-deferredrequeststate}
...
*Table - DeferredRequestState Definition* {#tbl-deferredrequeststate-definition defines=DeferredRequestState}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DeferredRequestState |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DeferredRequestTransition {#sec-deferredrequesttransition}
...
*Table - DeferredRequestTransition Definition* {#tbl-deferredrequesttransition-definition defines=DeferredRequestTransition}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DeferredRequestTransition |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DeferralRequestHeaderDataType {#sec-deferralrequestheaderdatatype}
...
*Table - DeferralRequestHeaderDataType Definition* {#tbl-deferralrequestheaderdatatype-definition defines=DeferralRequestHeaderDataType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DeferralRequestHeaderDataType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DeferralResponseHeaderDataType {#sec-deferralresponseheaderdatatype}
...
*Table - DeferralResponseHeaderDataType Definition* {#tbl-deferralresponseheaderdatatype-definition defines=DeferralResponseHeaderDataType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DeferralResponseHeaderDataType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### DeferredRequestDiagnosticsDataType {#sec-deferredrequestdiagnosticsdatatype}
...
*Table - DeferredRequestDiagnosticsDataType Definition* {#tbl-deferredrequestdiagnosticsdatatype-definition defines=DeferredRequestDiagnosticsDataType}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:DeferredRequestDiagnosticsDataType |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### CompleteRequest {#sec-completerequest}
...
*Table - CompleteRequest Definition* {#tbl-completerequest-definition defines=CompleteRequest}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:CompleteRequest |  |  |  |  |
| IsAbstract | False |  |  |  |  |
...
### CompleteResponse {#sec-completeresponse}
...
*Table - CompleteResponse Definition* {#tbl-completeresponse-definition defines=CompleteResponse}

| **Attribute** | **Value** |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| BrowseName | 0:CompleteResponse |  |  |  |  |
| IsAbstract | False |  |  |  |  |
